        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-6 font-sans transition-colors hover:opacity-80"
              style={{ color: "#5DCAA5", fontSize: "14px", fontWeight: 500 }}
            >
              ...
              Chat on WhatsApp · +971 54 161 1475
            </a>
          </motion.div>
        </div>
      </section>
